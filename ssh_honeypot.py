...
server_key = base_dir / 'NS' / 'server.key'

creds_audits_log_local_file_path = base_dir / 'NS' / 'log_files' / 'creds_audits.log'
cmd_audits_log_local_file_path = base_dir / 'NS' / 'log_files' / 'cmd_audits.log'
